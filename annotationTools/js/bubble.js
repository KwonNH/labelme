...
function GetPopupFormEdit(anno) {
  ...
  if(current_mode == "t"){
    ...
    html_str += '<input list="languagelist" />'; // insert list and close <input
    ...
    html_str += '<input name="translatedObj" id="translatedObj" type="text" style="width:220px;" tabindex="0" title="Enter the object\'s name here. Avoid application specific names, codes, long descriptions. Use a name you think other people would agree in using. " />';
